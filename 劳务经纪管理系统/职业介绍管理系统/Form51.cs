    ...
    public partial class Form51 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = conn;
                String userInfo = String.Format("SELECT 辞退编号,求职者.求职者编号,求职者姓名,求职者性别,求职者身份证号码,求职者学历层次,用人单位.单位编号,单位名称,单位所属行业,辞退原因 FROM 辞退,求职者,用人单位 where 辞退.求职者编号=求职者.求职者编号 and 辞退.单位编号=用人单位.单位编号 and 辞退.介绍人员编号='{0}'",Form1.user_name);
